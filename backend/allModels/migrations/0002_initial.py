...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Comments',
            fields=[
                ('uuid', models.CharField(default='6f1f63fe-28e5-4e2f-ac15-ef391dfa7a2d', max_length=255, unique=True)),
        ...
        migrations.CreateModel(
            name='Posts',
            fields=[
                ('uuid', models.CharField(default='8f5c48ad-ef8b-4848-bc00-2822472fa06a', editable=False, max_length=255, unique=True)),
